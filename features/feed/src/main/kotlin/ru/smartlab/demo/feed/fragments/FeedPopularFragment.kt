...
import ru.smartlab.demo.feed.adapter.TabAdapterFeedTop

class FeedPopularFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, group: ViewGroup?, state: Bundle?): View? {
        ...
        pager.adapter = TabAdapterFeedTop(requireContext(), childFragmentManager)
